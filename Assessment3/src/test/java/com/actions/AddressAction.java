...
public class AddressAction {
	...
	public void det(List<Map<String, String>> data) {
		...
		Select s1= new Select(driver.findElement(ap.country));
		s1.selectByVisibleText(data.get(0).get("country"));
		Select s2 = new Select(driver.findElement(ap.state));
		s2.selectByVisibleText(data.get(0).get("region"));
	}
